...
<!-- <script type="text/javascript">
  var paket;
  var paket_pesan;
  function PemesananBelumBayarFunction(){
  var user_id = document.getElementById("pengunjung").value;
  fetch("/admin-get_paket_belum_bayar/"+ user_id )
  .then(response => response.json())
  .then(data => paket = data)
  .then(() => {
    paket_pesan = paket.pemesanan.paket_id;
    document.getElementById("paket_dipesan").value = paket_pesan;
