                               ...
                               <div class="table-responsive">
                                  ...
                                  <table  class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          <td>{{ $no++ }}</td>
                                          <td>Rp. <?=number_format($laporan_pendapatan_hari, 0, ".", ".")?>,00</td>
                                          <td>Rp. <?=number_format($laporan_pendapatan_bulan, 0, ".", ".")?>,00</td>
                                          <td>Rp. <?=number_format($laporan_pendapatan_tahun, 0, ".", ".")?>,00</td>
